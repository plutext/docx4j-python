"""``el`` for the http://purl.org/dc/dcmitype/ namespace.
...
to are in ``codegen/el_tables/docprops_dcmitype.json``, which a human reviews.

    >>> from docx4j_py.docprops.dcmitype import el
    >>> el.p()  # doctest: +SKIP
