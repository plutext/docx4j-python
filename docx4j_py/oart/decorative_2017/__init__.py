...
# (``from docx4j_py.oart.decorative_2017 import el, p, r, t, wml, to_xml, text_of, walk, find``).
...
_PHASE_C: dict[str, str] = {
    ...
    "el": "docx4j_py.oart.decorative_2017.el",
