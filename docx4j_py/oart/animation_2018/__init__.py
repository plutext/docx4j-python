...
class STIndefinite(Enum):
    INDEFINITE = "indefinite"


@dataclass(slots=True, kw_only=True)
class CTAnimationProperties(Child):
    class Meta:
        name = "CT_AnimationProperties"
    ...
    ext_lst: None | CTOfficeArtExtensionList = field(
        ...
        metadata={
            "name": "extLst",
            "type": "Element",
            "namespace": "http://schemas.microsoft.com/office/drawing/2018/animation",
        },
    )
    name: None | str = field(
        default=None,
    ...
    length: None | str = field(
        default=None,
        metadata={
            "type": "Attribute",
        },
    )
    count: None | int | STIndefinite = field(
        default=None,
        metadata={
            "type": "Attribute",
            "schema_default": "1",
...
# (``from docx4j_py.oart.animation_2018 import el, p, r, t, wml, to_xml, text_of, walk, find``).
...
_PHASE_C: dict[str, str] = {
    ...
    "el": "docx4j_py.oart.animation_2018.el",
