...
__NAMESPACE__ = "http://schemas.microsoft.com/office/drawing/2018/hyperlinkcolor"


class STHyperlinkColor(Enum):
    HLINK = "hlink"
    TX = "tx"


@dataclass(slots=True, kw_only=True)
class CTHyperlinkColor(Child):
    class Meta:
        name = "CT_HyperlinkColor"

    val: None | STHyperlinkColor = field(
        default=None,
        metadata={
            "type": "Attribute",
        },
...
@dataclass(slots=True, kw_only=True)
class HlinkClr(CTHyperlinkColor):
    class Meta:
        name = "hlinkClr"
...
# (``from docx4j_py.oart.hyperlink_color_2018 import el, p, r, t, wml, to_xml, text_of, walk, find``).
...
_PHASE_C: dict[str, str] = {
    ...
    "el": "docx4j_py.oart.hyperlink_color_2018.el",
