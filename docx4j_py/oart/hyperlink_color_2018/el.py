"""``el`` for the http://schemas.microsoft.com/office/drawing/2018/hyperlinkcolor namespace.
...
to are in ``codegen/el_tables/oart_hyperlink_color_2018.json``, which a human reviews.

    >>> from docx4j_py.oart.hyperlink_color_2018 import el
    >>> el.hlinkClr()  # doctest: +SKIP
...
def hlinkClr(**kwargs: Any) -> HlinkClr:
    """``{http://schemas.microsoft.com/office/drawing/2018/hyperlinkcolor}hlinkClr`` -> :class:`docx4j_py.oart.hyperlink_color_2018.HlinkClr`."""
    return HlinkClr(**kwargs)

#: Element qualified name -> the class ``el.<name>`` builds.
QNAME_TO_CLASS: dict[str, type] = {
    "{http://schemas.microsoft.com/office/drawing/2018/hyperlinkcolor}hlinkClr": HlinkClr,
}
...
CLASS_TO_QNAME: dict[type, str] = {
    HlinkClr: "{http://schemas.microsoft.com/office/drawing/2018/hyperlinkcolor}hlinkClr",
}
