...
from docx4j_py.dml.chart import CTMultiLvlStrData

__NAMESPACE__ = "http://schemas.microsoft.com/office/drawing/2014/chart/ac"


@dataclass(slots=True, kw_only=True)
class MultiLvlStrLit(CTMultiLvlStrData):
    class Meta:
        name = "multiLvlStrLit"
        namespace = "http://schemas.microsoft.com/office/drawing/2014/chart/ac"


# CR-001 Phase C: el, the fragment helpers and the text sugar, reached
# through this package as CR-001 section 6.2 writes them
# (``from docx4j_py.oart.chart_ac_2014 import el, p, r, t, wml, to_xml, text_of, walk, find``).
...
_PHASE_C: dict[str, str] = {
    ...
    "el": "docx4j_py.oart.chart_ac_2014.el",
