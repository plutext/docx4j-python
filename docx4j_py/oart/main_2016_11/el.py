"""``el`` for the http://schemas.microsoft.com/office/drawing/2016/11/main namespace.
...
to are in ``codegen/el_tables/oart_main_2016_11.json``, which a human reviews.

    >>> from docx4j_py.oart.main_2016_11 import el
    >>> el.picAttrSrcUrl()  # doctest: +SKIP
...
def picAttrSrcUrl(**kwargs: Any) -> PicAttrSrcUrl:
    """``{http://schemas.microsoft.com/office/drawing/2016/11/main}picAttrSrcUrl`` -> :class:`docx4j_py.oart.main_2016_11.PicAttrSrcUrl`."""
    return PicAttrSrcUrl(**kwargs)

#: Element qualified name -> the class ``el.<name>`` builds.
QNAME_TO_CLASS: dict[str, type] = {
    "{http://schemas.microsoft.com/office/drawing/2016/11/main}picAttrSrcUrl": PicAttrSrcUrl,
}

#: Local element name -> the class ``el.<name>`` builds.
ELEMENTS: dict[str, type] = {
    "picAttrSrcUrl": PicAttrSrcUrl,
}

#: Class -> the one element qualified name it stands for, where there is one.
CLASS_TO_QNAME: dict[type, str] = {
    PicAttrSrcUrl: "{http://schemas.microsoft.com/office/drawing/2016/11/main}picAttrSrcUrl",
}
