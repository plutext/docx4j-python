...
class LstStyle(CTTextListStyle):
    class Meta:
        name = "lstStyle"
...
# (``from docx4j_py.oart.diagram_2016_12 import el, p, r, t, wml, to_xml, text_of, walk, find``).
...
_PHASE_C: dict[str, str] = {
    ...
    "el": "docx4j_py.oart.diagram_2016_12.el",
