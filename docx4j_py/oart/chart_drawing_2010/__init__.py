...
class CTContentPartNonVisual(Child):
    ...
    c_nv_pr: None | CTNonVisualDrawingProps = field(
        ...
        metadata={
            "name": "cNvPr",
            "type": "Element",
            "namespace": "http://schemas.microsoft.com/office/drawing/2010/chartDrawing",
        },
    )
...
# (``from docx4j_py.oart.chart_drawing_2010 import el, p, r, t, wml, to_xml, text_of, walk, find``).
...
_PHASE_C: dict[str, str] = {
    ...
    "el": "docx4j_py.oart.chart_drawing_2010.el",
