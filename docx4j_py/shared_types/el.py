"""``el`` for the http://schemas.openxmlformats.org/officeDocument/2006/sharedTypes namespace.
...
to are in ``codegen/el_tables/shared_types.json``, which a human reviews.

    >>> from docx4j_py.shared_types import el
    >>> el.p()  # doctest: +SKIP
