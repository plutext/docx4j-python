...
__NAMESPACE__ = "http://schemas.openxmlformats.org/officeDocument/2006/sharedTypes"
...
# (``from docx4j_py.shared_types import el, p, r, t, wml, to_xml, text_of, walk, find``).
